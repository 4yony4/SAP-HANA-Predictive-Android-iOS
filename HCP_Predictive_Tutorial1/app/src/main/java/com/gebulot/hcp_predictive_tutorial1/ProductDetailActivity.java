package com.gebulot.hcp_predictive_tutorial1;
...
import com.gebulot.hcp_predictive_tutorial1.SAPAdmin.SAPAdmin;
import com.sap.*;
...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SAPAdmin sapAdmin=new SAPAdmin();
        sapAdmin.init(this,"URL");
        try{
            sapAdmin.executeRequest("PAL REQUEST");
        }catch (Exception e){
            e.printStackTrace();
        }
